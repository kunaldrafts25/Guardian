...
class SafetyNotificationManager {
  static final SafetyNotificationManager _instance =
  ...
  Stream<Map<String, dynamic>> get safetyAlertStream =>
      _safetyAlertController.stream;
  ...
  Future<void> initialize() async {
    try {
      ...
      _riskLevelSubscription =
          _aiService.riskLevelStream.listen(_handleRiskLevelChange);

      // Listen for safety suggestions
      _safetySuggestionSubscription =
          _aiService.safetySuggestionStream.listen(_handleSafetySuggestion);
  ...
  Future<void> showSafetyAlertDialog(
