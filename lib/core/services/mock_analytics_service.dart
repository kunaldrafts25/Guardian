...
/// A mock analytics observer to replace Firebase Analytics Observer
class MockAnalyticsObserver extends NavigatorObserver {
  @override
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    super.didPush(route, previousRoute);
    if (route.settings.name != null) {
      MockAnalyticsService.logScreenView(screenName: route.settings.name!);
    }
  }
}
...
class MockAnalyticsService {
  ...
  static MockAnalyticsObserver? _observer;
  static final List<Map<String, dynamic>> _events = [];

  /// Get analytics observer
  static MockAnalyticsObserver? get observer => _observer;
  ...
  static Future<void> init() async {
    ...
    try {
      ...
      Logger.error('Error initializing mock analytics service', e);
    }
  }
