...
/// Compatibility layer for FirestoreService backed by Cloud Firestore
class FirestoreService {
  ...
  static Future<bool> initialize() async {
    if (_initialized) {
      Logger.info('FirestoreService already initialized');
      return true;
    }
    ...
    try {
      ...
      _initialized = true;
      Logger.info('FirestoreService initialized (Firestore-backed)');
      return true;
    } catch (e) {
      Logger.error('Error initializing FirestoreService', e);
      return false;
    }
  }
