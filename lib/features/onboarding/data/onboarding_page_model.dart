...
List<OnboardingPageModel> onboardingPages = [
  OnboardingPageModel(
    ...
    description:
        'Your personal safety companion that helps you stay protected wherever you go.',
  ...
  OnboardingPageModel(
    title: 'Emergency SOS',
    description:
        'Long press the SOS button in case of emergency to alert your trusted contacts with your location.',
  ...
  OnboardingPageModel(
    title: 'Safety Map',
    description:
        'View safe routes, danger zones, and nearby helpers on the interactive map.',
  ...
  OnboardingPageModel(
    ...
    description:
        'Connect with wearable safety devices for quick access to emergency features.',
